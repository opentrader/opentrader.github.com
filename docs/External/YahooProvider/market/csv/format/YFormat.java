...
public class YFormat {
    ...
    private java.util.ArrayList<YTag> tagList = new java.util.ArrayList(10);
    private java.util.HashMap<String, YTag> tagMap = new java.util.HashMap(10);
    ...
    public java.util.ArrayList<YTag> getEnabledTags() {
        java.util.ArrayList<YTag> list = new java.util.ArrayList<YTag>(10);
    ...
    public void setStatusOn(String code) {
        ...
        if (tag != null) {
            ...
            throw new com.opentrader.market.csv.exception.UnknownTagException();
        }
    }
