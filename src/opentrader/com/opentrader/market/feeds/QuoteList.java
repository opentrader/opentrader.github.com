 ...
 *  @version   0.00.00
 *  %name      QuoteList.java
 *  %pkg       com.opentrader.market.feeds
 *  %date      9:21:39 AM, Dec 14, 2010
 */
public interface QuoteList {

    Quote getStockQuote(String code);
    Quote getStockQuote(Symbol symbol);

    void add(Symbol symbol);
    void remove(Symbol symbol);
    void clear();

    String getUrlSymbolParameter();
