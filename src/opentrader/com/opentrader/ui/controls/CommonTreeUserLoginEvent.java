 ...
 *  @version   0.00.00
 *  %name      CommonTreeUserLoginEvent.java
 *  %pkg       com.opentrader.ui.controls
 *  %date      2:39:51 PM, Oct 9, 2010
 */
public class CommonTreeUserLoginEvent extends EventObject {

    private static final long serialVersionUID = 1017635207705754658L;

    private static final Logger LOG = Logger.getLogger("opentrader");

    public CommonTreeUserLoginEvent(Object source) {
        super(source);
    }
