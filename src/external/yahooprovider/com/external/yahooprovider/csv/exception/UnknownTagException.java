...
package com.external.yahooprovider.csv.exception;
 ...
 *  @version   0.00.00
 *  %name      UnknownTagException.java
 *  %pkg       com.external.yahooprovider.csv.exception
 *  %date      7:42:55 AM, Dec 14, 2010
 */
public class UnknownTagException extends RuntimeException {

    private static final long serialVersionUID = -2844834939423242391L;
